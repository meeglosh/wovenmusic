      ...
      <div className="p-4">
        <nav className="space-y-2">
          ...
          >
            ...
            <span className="text-primary text-lg font-semibold">{libraryTitle}</span>
          </Button>
        </nav>
      </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2">
                        <p className="text-lg font-semibold text-primary break-words whitespace-normal leading-tight">{playlist.name}</p>
